...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { codigo: @produto.codigo, nome: @produto.nome, valor: @produto.valor } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { codigo: @produto.codigo, nome: @produto.nome, valor: @produto.valor } }
